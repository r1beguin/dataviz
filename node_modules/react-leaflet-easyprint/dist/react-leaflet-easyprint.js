...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _PrintControl = __webpack_require__(1);

	var _PrintControl2 = _interopRequireDefault(_PrintControl);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.default = _PrintControl2.default;
	...
	var PrintControl = function (_MapControl) {
		...
		_createClass(PrintControl, [{
			...
			value: function createLeafletElement(props) {
				return _leaflet2.default.easyPrint(props);
			}
		}, {
			...
			key: 'printMap',
			value: function printMap(size, filename) {
